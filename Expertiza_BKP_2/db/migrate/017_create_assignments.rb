class CreateAssignments < ActiveRecord::Migration
  ...
  create_table "assignments", :force => true do |t|
    ...
    t.column "bookmarkrating_questionnaire_id", :integer
  ...
  execute "alter table assignments
             add constraint fk_assignments_bookmarkrating_questionnaires
             foreign key (bookmarkrating_questionnaire_id) references questionnaires(id)"
